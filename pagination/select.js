...
$.fn.dataTableExt.oPagination.listbox = {
     ...
     * Purpose:  Initialize dom elements required for pagination with listbox input
     * Returns:  -
    ...
    "fnUpdate": function(oSettings, fnCallbackDraw) {
        ...
        var iCurrentPage = Math.floor(oSettings._iDisplayStart / oSettings._iDisplayLength) + 1;
        ...
        for (var i = 0, iLen = an.length; i < iLen; i++) {
            ...
            if (elSel.options.length !== iPages) {
                ...
                for (var j = 0; j < iPages; j++) { //add the pages
                    ...
                    oOption.text = "Page " + (j + 1) + " of " + iPages;
                    oOption.value = j + 1;
                    try {
                ...
                spans[1].innerHTML = "Page " + iCurrentPage + " of " + iPages;
            }
